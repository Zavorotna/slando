<x-app-layout>
    <x-slot name="slot">
        <div class="p-6">
            <a class="text-[#fff]  text-2xl inline-block w-sm mb-10 py-3 px-6 duration-300 ease-in border border-white rounded-sm hover:bg-white hover:text-[#000]" href="{{ route('admin.subsubcategory.create') }}">Create</a>
            <table class="text-[#fff] w-full border border-white border-spacing-0">
                <thead>
                    <tr class="border-b text-center">
                        ...
                        <td class="p-2 border-r">Edit</td>
                        <td class="p-2 border-r">Delete</td>
                    </tr>
                </thead>
                <tbody>
