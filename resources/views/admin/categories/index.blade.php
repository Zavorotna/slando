<x-app-layout>
    <x-slot name="slot">
        <div class="p-6">
            <a class=" text-2xl inline-block w-sm mb-10 py-3 px-6 duration-300 ease-in border border-black rounded-sm hover:bg-white hover:text-[#000]" href="{{ route('admin.category.create') }}">Create</a>
            <table class="w-full border border-white border-spacing-0">
                <thead>
                    <tr class="">
                ...
                <tbody>
                    @foreach ($categories as $c)
                        <tr class=" text-center">
                            ...
                            <td class="p-2 ">
                                <a class="inline-block" href="{{ route('admin.category.edit', $c->id) }}">
            ...
            {{ $categories->withQueryString()->onEachSide(2)->links('vendor.pagination.custom') }}
        </div>
    </x-slot>
</x-app-layout>
